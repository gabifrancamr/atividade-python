...
desfoque = cv2.GaussianBlur(imagem_redimensionada, (15, 15), 0) # Aplica um desfoque gaussiano à imagem redimensionada usando um kernel de 15x15, suavizando a imagem
